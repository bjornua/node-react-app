    ...
    if (server === undefined) {
        server = nodemon({
            ...
            .on('crash', function () {
                ...
                server_reloaded.resolve();
                server_reloaded = Q.defer();
            })
            .on('error', function () {
                console.log(arguments);
            })
        ...
        var promise = server_reloaded.promise;
        server.emit('restart');
        return promise;
    }
});
